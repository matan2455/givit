...
def coordinator_create_view(request):
    ...
    if request.method == 'GET':
        ...
        #     "pickup_location":'Jerusalem',
        #     "drop_off_location":'Tel Aviv',
        #     "url": 'https://ak1.ostkcdn.com/images/products/13223495/TidySquares-Classic-White-Wood-63-Reachin-Closet-Organizer-Design-2-998c7350-e3b4-4cfd-b3eb-67998079718c.jpg',
        #     "friend_id":"1235",
        #     "picture": '',
        #     "request_id": '2',
        #     "user_id": '3'
